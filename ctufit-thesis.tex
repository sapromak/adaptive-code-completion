...
\part{Conceptual Framework}  % other options are Theoretical Background, Theoretical Part, Foundational Concepts
\include{text/code-completion}
\include{text/standard-lm}
\include{text/completion-centric-lm}
\include{text/in-context-learning}
\include{text/long-context}
\part{Applied Research}  % other options are Experimental Analysis, Research Part, Experimental Validation
